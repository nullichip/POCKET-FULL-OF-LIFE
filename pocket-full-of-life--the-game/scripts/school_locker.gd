...
func _ready() -> void:
	locker.play("closed_school_locker")
...
func open_interaction() -> void:
	...
	locker.play("open_school_locker")
	is_open = true
	...
	#var ui_layer = get_tree().current_scene.get_node("UI_Layer_Hall")
...
func close_interaction() -> void:
	...
	locker.play("close_school_locker")
	is_open = false
